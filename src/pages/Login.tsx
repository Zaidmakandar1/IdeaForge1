...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome back!",
        description: "You've successfully logged in to IdeaForge.",
      });
      ...
      if (redirect) {
        // Use window.location.href for absolute navigation
          ...
          <Card className="glass-card border-white/20">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-gray-300">
                Sign in to your IdeaForge account to continue collaborating
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              ...
              <div className="mt-6">
                ...
                <Button
                  variant="outline"
                  className="w-full mt-4 glass border-white/20 hover:bg-white/10"
                  onClick={() => {
